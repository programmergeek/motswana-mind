    ...
    return(
        <Layout>
            ...
            <div className="outline h-[300px] w-[1000px] rounded-3xl shadow-2xl">
                <div className="bg-[#289CFF] rounded-t-3xl p-4 border-b-black">
            ...
            <div>
                <p className="text-2xl font-playfair pt-10 pb-14 font-semibold text-center mx-96">
                    Ready to test out your newly acquired knowledge on algebra?
                </p>
                <p className="text-xl pb-5 text-center">
                    Take this 20 minute test to assess your skill on algebra.
                </p>
